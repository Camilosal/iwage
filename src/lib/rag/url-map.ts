...
export const URL_MAP: SitePage[] = [
  ...
  { url: '/meliponas/herramientas', brand: 'meliponas', title: 'Herramientas del Meliponario', desc: 'Panel de herramientas: trazabilidad, Modelador Técnico Financiero ↗ e Intranet.', keywords: ['herramientas', 'modelador', 'financiero', 'intranet', 'panel'] },
  ...
  { url: '/gestion/propietarios', brand: 'gestion', title: 'Modelos de Gestión para Propietarios', desc: 'Renta corta, finca productiva, segunda residencia y operación turística.', keywords: ['servicios', 'renta corta', 'finca productiva', 'segunda residencia', 'operacion turistica', 'glamping', 'propietarios'] },
